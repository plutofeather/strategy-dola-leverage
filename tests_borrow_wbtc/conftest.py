...
@pytest.fixture
def strategy(strategist, keeper, vault, StrategyBorrowERC20, gov, cWant, cBorrowed, delegatedVault, cSupplied, name):
    strategy = strategist.deploy(StrategyBorrowERC20, vault, cWant, cBorrowed, delegatedVault, name)
